/**
 * Podfile surgery for the Expo config plugin. Kept out of plugin/src/index.ts because
 * app.plugin.js re-exports that module and package.json exposes "./app.plugin.js", so
 * anything exported there ships as public API on day one.
 */
 ...
 * subsequent prebuilds. Exercised directly by podfile.test.ts.
 */
